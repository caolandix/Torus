...
# Colour for the crew members
A_COLOR = (0,0,255)     # Astronomer
H_COLOR = (0,255,0)     # Hunter
C_COLOR = (255,0,0)     # Captain
...
RADIUS_FREE = 6
PI_VALUE = 3.14159
MAX_CHUNKS = int(PI_VALUE * RADIUS_FREE ** 2) + 1
