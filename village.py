...
##    probability_y = 1. - chunky/(game.cam.world_size[1]*parameters.MAX_VILLAGE_DIST)
    ...
    chunk_dist = chunk_x * chunk_x + chunk_y * chunk_y
...
class Village(FoodStock):
    ...
    def __init__(self, imgs, pos, n, id_):
        ...
        self.max_water = 1000000            # unlimited water found in villages
        ...
        for x in range(occupied.shape[0]):
            ...
            for y in range(occupied.shape[1]):
                if occupied[x, y]:
                    ...
                    pos += np.random.randint(-parameters.HOUSE_RAND, parameters.HOUSE_RAND, 2)
                    img = imgs[type_[x, y]]
